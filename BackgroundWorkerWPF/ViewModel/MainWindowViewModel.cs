    ...
    class MainWindowViewModel : ViewModelBase, IDisposable
    {
        ...
        private void RunWorkerCompleted_Handler( object sender, RunWorkerCompletedEventArgs args )
        {
            ...
            if( args.Cancelled )
            {
                ...
                MessageBox.Show( string.Format( CultureInfo.CurrentCulture, Properties.Resources.ProcessCancelled),  string.Format( CultureInfo.CurrentCulture, Properties.Resources.ProcessCancelledTitle ) );
            }
            else
            {
                // Tell the user that the process completed normally
                MessageBox.Show( string.Format( CultureInfo.CurrentCulture, Properties.Resources.ProcessCompleted ), string.Format( CultureInfo.CurrentCulture, Properties.Resources.ProcessCompletedTitle ) );
            }
        }
